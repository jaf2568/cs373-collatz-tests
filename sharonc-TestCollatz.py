...
from Collatz import collatz_read, collatz_eval, collatz_print, collatz_solve, collatz_lazyeval
...
class TestCollatz (unittest.TestCase) :
    ...
    def test_lazyeval_1(self):
	s = collatz_lazyeval (3) 
	self.assert_(s == 8)

    def test_lazyeval_2(self):
	s = collatz_lazyeval (4) 
	self.assert_(s == 3)
